...
// 定义的错误类型码
var ERROR_RUNTIME = 1; //运行时错误

var ERROR_SCRIPT = 2; //脚本错误
var ERROR_STYLE = 3; //样式
var ERROR_IMAGE = 4; //图片
var ERROR_AUDIO = 5; //音频
var ERROR_VIDEO = 6; //视频
...
//加载错误类型
var LOAD_ERROR_TYPE = {
  SCRIPT: ERROR_SCRIPT, //SCRIPT脚本
  LINK: ERROR_STYLE, //样式
  IMG: ERROR_IMAGE, //图片
  AUDIO: ERROR_AUDIO, //音频
  VIDEO: ERROR_VIDEO //视频
};
